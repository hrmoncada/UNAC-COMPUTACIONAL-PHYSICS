/*
https://people.math.sc.edu/Burkardt/c_src/c_calls_f90/c_calls_f90.html
*/
...
/* Interfaces to FORTRAN77 routines. The names now have underscores appended, and scalar parameters are passed by reference.*/
#include "kronrod.h"
...
int main ( )
/******************************************************************************/
/* Purpose: MAIN is the main program for KRONROD_TEST. */
{
  timestamp_ ( );
  printf ( "\n" );
  printf ( "KRONROD_TEST:\n" );
...
void test01 ( void )
/******************************************************************************/
/* Purpose: TEST01 tests the code for the odd case N = 3.*/
{
  double *b;
  double eps;
  int i;
...
void test02 ( void )
/******************************************************************************/
/* Purpose: TEST02 tests the code for the even case N = 4.*/
{
  double *b;
  double eps;
  int i;
